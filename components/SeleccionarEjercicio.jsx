      ...
      <div className="h-full w-11/12 md:w-9/12 mx-auto max-w-5xl">
          ...
          <div>
            ...
            <div className="relative flex flex-row">
              ...
              <button type="submit" onClick={getEjercicios} className="btn text-white absolute right-2 lg:right-3 lg:bottom-2 btn-secondary rounded-lg btn-sm top-2 lg:px-6 lg:py-2">BUSCAR</button>
            </div>
